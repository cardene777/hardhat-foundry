...
export interface HardhatFoundryERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface HardhatFoundryERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): HardhatFoundryERC721;
  waitForDeployment(): Promise<this>;

  interface: HardhatFoundryERC721Interface;
